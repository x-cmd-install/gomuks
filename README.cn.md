...
![gomuks](https://repo.x-cmd.io/gomuks.svg?lang=zh)
...
合计: **90,968** 行代码（覆盖前 5 种语言、共 **416** 个文件）。
...
- **Star**: 1,720 · **Fork**: 150 · **开放 issue**: 541 · **贡献者**: 33

## 累计统计

- **发布数**: 20 · **已合并 PR**: 120 · **开放 PR**: 20 · **已关闭 issue**: 483 · **开放 issue**: 58 · **提交数**: 2414
...
在 [repology.org](https://repology.org/project/gomuks) 上共有 **68** 个发行版报告此项目。**5** 个 ✅ 已是最新上游版本，**60** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T06:10:15Z._
