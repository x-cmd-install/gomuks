...
[![x-cmd/install — gomuks Code Quality Monitoring Repo Card](https://repo.x-cmd.io/gomuks.svg?lang=zh)](https://x-cmd.com/install/gomuks)
...
合计: **91,347** 行代码（覆盖前 5 种语言、共 **416** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 33,616 | 0 | 0 | 9 |
| Go | 26,520 | 2,589 | 2,822 | 165 |
| Tsx | 14,219 | 1,786 | 729 | 112 |
...
- **上游仓库**: <https://github.com/tulir/gomuks>
- **官网**: <https://gomuks.app>
- **许可证**: AGPL-3.0
...
- **Star**: 1,724 · **Fork**: 151 · **开放 issue**: 541 · **贡献者**: 33

## 累计统计

- **发布数**: 21 · **已合并 PR**: 121 · **开放 PR**: 21 · **已关闭 issue**: 483 · **开放 issue**: 58 · **提交数**: 2444
...
| last720d | 2024-09-30 | 11 | 0 | 0 | 0 | 0 | 0 |
...
gomuks 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `gomuks` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gomuks.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T06:04:02Z._
